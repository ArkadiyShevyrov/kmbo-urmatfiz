...
\begin{sol}
	...
	\Definition{Обобщённая функция}{
		непрерывный линейный функционал $T: C_c^\infty(\mathbb{R})\to\mathbb{R}$,
		$\varphi\mapsto\langle T, \varphi \rangle$,
		Здесь $C_c^\infty(\mathbb{R})$ -- пространство тест-функций $\varphi$.
	}

	\Definition{Дельта-функция Дирака}{
		обобщённая функция $\delta$, определяемая действием
		$\langle \delta, \varphi \rangle = \varphi(0)$
		для любой $\varphi \in C_c^\infty(\mathbb{R})$.
	...
	\Definition{Производная обобщённой функции}{
		...
		действующая на тест-функции $\varphi \in C_c^\infty(\mathbb{R})$ по правилу
